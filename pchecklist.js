...
var passwordCheckOld = function () 
{
    ...
    if (stringPassword.length<8) // Checks to see if password is more than 8 characters and returns alert.  
    {
       stringOutput = "Your password is too short.";
    }
    //If the password is longer than 8, it goes on to check if the password is part of the array of commmonly used passwords
    else
    {
       ...
       for (var f=0; f < arrayBadPasswords.length; f++)
       {
          ...
          {
             stringOutput = "Your password is bad.";
          }
       }
    }
