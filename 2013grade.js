...
floatFinPts = parseFloat(prompt("Please enter your Final exam pts (0-35):"));

floatTotalPts = parseFloat(floatHwPts + floatMidPts + floatFinPts);

intGradeOption = parseInt(prompt("Please select whether the course is P/F or a course grade (1 or 2)"));
