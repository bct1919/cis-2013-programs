...
var generate = function () 
{
    ...
    if (intCount < 1 || intCount > 100 || isNaN(intCount)) // validates that the user input is greater than 1 and is a number.
    {
        alert("Invalid Number. Input a number between 1 and 100");
    }
    else
    {
        while (intCount>2) //counting down
        {
            k = i + j;
            i = j;
            j = k;
